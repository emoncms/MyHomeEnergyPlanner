...
var standard_library = {
    elements: {
        ...
        "SWU_01": {
            tags: ["Wall"],
            name: "Uninsulated 225mm brick wall",
        ...
        "SWU_04": {
            tags: ["Wall"],
            name: "Uninsulated 300mm solid granite or whinstone wall",
            description: "",
            location: "",
        ...
        "SWU_05": {
            tags: ["Wall"],
            name: "Uninsulated 450mm solid granite or whinstone wall",
            description: "",
            location: "",
            source: "SAP p.134\/SAP table 1e, p.195",
            uvalue: 2.1,
        ...
        "CWU_01": {
            tags: ["Wall"],
            name: "Uninsulated Cavity Masonry Wall - 25mm Cavity",
            description: "",
            location: "",
        ...
        "CWU_02": {
            tags: ["Wall"],
            name: "Uninsulated Cavity Masonry Wall - 50mm to 100mm Cavity",
            description: "",
            location: "",
            source: "SAP table S6, p.131\/ SAP table 1e, p.195",
            uvalue: 1.6,
...
standard_library.heating_systems["GSHP1"] = {
    name: "Ground-source heat pump (Energy Saving Trust 2013 average SPFH4: 2.82)",
    category: 'Heat pumps',
    winter_efficiency: 282,
    summer_efficiency: 282,
    central_heating_pump: 0,
    fans_and_supply_pumps: 0,
    responsiveness: 1,
    combi_loss: 0,
...
standard_library_clone_modify("heating_systems","GSHP1","GSHP2",{
...
standard_library.heating_systems["ASHP1"] = {
    name: "Air-source heat pump (Energy Saving Trust 2013 average SPFH4: 2.45)",
    category: 'Heat pumps',
    winter_efficiency: 245,
    summer_efficiency: 245,
    central_heating_pump: 0,
    fans_and_supply_pumps: 0,
    responsiveness: 1,
    combi_loss: 0,
...
standard_library.heating_systems_measures
...
function standard_library_clone_modify(category,clonefrom,newtag,options) {
    standard_library[category][newtag] = standard_library[category][clonefrom];
    standard_library_update(category,newtag,options);
}

function standard_library_update(category,tag,options) {
    for (var z in options) {
        standard_library[category][tag][z] = options[z];
    }
}
