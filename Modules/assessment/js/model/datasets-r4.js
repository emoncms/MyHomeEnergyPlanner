...
var datasets = {
    fuels: {// standing charge in £, unit cost in p/kWh
        'Mains Gas': {category: 'Gas', standingcharge: 101, fuelcost: 4.25, co2factor: 0.216, primaryenergyfactor: 1.22, SAP_code: 1},
        'Bulk LPG': {category: 'Gas', standingcharge: 70, fuelcost: 8.46, co2factor: 0.241, primaryenergyfactor: 1.09, SAP_code: 2},
        'Bottled LPG ': {category: 'Gas', standingcharge: 0, fuelcost: 10.61, co2factor: 0.241, primaryenergyfactor: 1.09, SAP_code: 3},
        'Heating Oil': {category: 'Oil', standingcharge: 0, fuelcost: 5.43, co2factor: 0.298, primaryenergyfactor: 1.1, SAP_code: 4},
        'House Coal': {category: 'Solid fuel', standingcharge: 0, fuelcost: 4.01, co2factor: 0.394, primaryenergyfactor: 1, SAP_code: 11},
        'Anthracite': {category: 'Solid fuel', standingcharge: 0, fuelcost: 4.02, co2factor: 0.394, primaryenergyfactor: 1, SAP_code: 15},
        'Manufactured smokeless fuel': {category: 'Solid fuel', standingcharge: 0, fuelcost: 5.04, co2factor: 0.433, primaryenergyfactor: 1.21, SAP_code: 12},
        'Wood Logs': {category: 'Solid fuel', standingcharge: 0, fuelcost: 4.65, co2factor: 0.019, primaryenergyfactor: 1.04, SAP_code: 20},
        'Wood Pellets (secondary heating/ in bags)': {category: 'Solid fuel', standingcharge: 0, fuelcost: 6.3, co2factor: 0.039, primaryenergyfactor: 1.26, SAP_code: 22},
        'Wood pellets (main heating/ bulk supply)': {category: 'Solid fuel', standingcharge: 0, fuelcost: 5.7, co2factor: 0.039, primaryenergyfactor: 1.26, SAP_code: 23},
        'Wood chips': {category: 'Solid fuel', standingcharge: 0, fuelcost: 3.36, co2factor: 0.016, primaryenergyfactor: 1.12, SAP_code: 21},
        'Dual Fuel Appliance': {category: 'Solid fuel', standingcharge: 0, fuelcost: 4.36, co2factor: 0.226, primaryenergyfactor: 1.02, SAP_code: 10},
        'Standard Tariff': {category: 'Electricity', standingcharge: 66, fuelcost: 15.06, co2factor: 0.519, primaryenergyfactor: 3.07, SAP_code: 30},
        '7-Hour tariff - High Rate': {category: 'Electricity', standingcharge: 13, fuelcost: 17.81, co2factor: 0.519, primaryenergyfactor: 3.07, SAP_code: 32},
        '7 Hour tariff - Low Rate': {category: 'Electricity', standingcharge: 0, fuelcost: 6.67, co2factor: 0.519, primaryenergyfactor: 3.07, SAP_code: 31},
        '10-hour tariff - High Rate': {category: 'Electricity', standingcharge: 12, fuelcost: 17.1, co2factor: 0.519, primaryenergyfactor: 3.07, SAP_code: 34},
        '10-hour tariff - Low Rate': {category: 'Electricity', standingcharge: 0, fuelcost: 9.25, co2factor: 0.519, primaryenergyfactor: 3.07, SAP_code: 33},
        '24-hour heating tariff': {category: 'Electricity', standingcharge: 40, fuelcost: 7.75, co2factor: 0.519, primaryenergyfactor: 3.07, SAP_code: 35},
        'generation': {category: 'generation', standingcharge: 0, fuelcost: 15.06, co2factor: 0.519, primaryenergyfactor: 3.07, SAP_code: 0}
    },
    regions: [
        "UK average",
        "Thames",
