...
<ul class="nav pull-right">
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu">
            <li><a href="<?php echo $path; ?>input/view">Input</a></li>
            <li><a href="<?php echo $path; ?>feed/list">Feed</a></li>
            <li><a href="<?php echo $path; ?>vis/list">Visualisations</a></li>
            <li><a href="<?php echo $path; ?>dashboard/view">Dashboards</a></li>
        </ul>
